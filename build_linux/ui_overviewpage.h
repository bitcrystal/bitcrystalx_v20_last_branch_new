...
public:
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "<html><head/><body><p>The displayed information may be out of date. Your wallet automatically synchronizes with the BitCrystalX network after a connection is established, but this process has not completed yet.</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
