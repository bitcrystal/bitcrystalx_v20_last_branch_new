...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        copyrightLabel->setText(QString::fromUtf8("Copyright &copy; 2009-YYYY The Bitcoin developers, 2013 The Quarkcoin developers, 2013-2014 The BitQuark developers, 2014 The BitCrystalXEx developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About BitCrystalX", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("AboutDialog", "<html><head/><body><p><span style=\" font-weight:600;\">BitCrystalX</span> version</p></body></html>", 0, QApplication::UnicodeUTF8));
