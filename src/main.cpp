...
int64 CTransaction::nMinTxFee = IS_FREE != 1 ? 10 : 0;  // Override with -mintxfee
/** Fees smaller than this (in satoshi) are considered zero fee (for relaying) */
int64 CTransaction::nMinRelayTxFee = IS_FREE != 1 ? 100 : 0;
...
// Settings
int64 nTransactionFee = IS_FREE != 1 ? 0 : 0;
...
//        nBlockMaxSize = std::min(nBlockMaxSize, (unsigned int)(MAX_BLOCK_SIZE_GEN));
    ...
    int64 nFees = 0;
    {
        ...
        bool fSortedByFee = IS_FREE != 1 ? (nBlockPrioritySize <= 0) : false;
